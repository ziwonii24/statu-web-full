...
export const deleteDayScheduleOnModal = createAction(DELETE_DAYSCHEDULE_ON_MODAL)<DaySchedule>()
...
export const deleteSubScheduleOnModal = createAction(DELETE_SUBSCHEDULE_ON_MODAL)<SubSchedule>()
